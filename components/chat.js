...
export default function () {
  ...
  return (
    <>
      <a
        href="https://www.instagram.com/studio.membiru/"
        target="_blank"
        className="fixed bottom-32 right-6 "
      >
        <div 
        className="inset-0.5 inset-x-0.5 ml-1.5 mt-1"
        >
          <Image width={45} height={45} src="/images/ig.png" alt="IG" />
        </div>
      </a>
      <a
      ...
      >
        ...
        <svg
          ...
          className="absolute inset-0.5 inset-x-0.5 ml-1.5 mt-1"
        >
          <path
            fill="#E0E0E0"
        ...
        <span className="animate-wave delay-75 absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75"></span>
